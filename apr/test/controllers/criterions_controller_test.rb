...
class CriterionsControllerTest < ActionController::TestCase
  ...
  test "should create criterion" do
    assert_difference('Criterion.count') do
      post :create, criterion: { criterion_number: @criterion.criterion_number, description: @criterion.description }
    end
  ...
  test "should update criterion" do
    patch :update, id: @criterion, criterion: { criterion_number: @criterion.criterion_number, description: @criterion.description }
    assert_redirected_to criterion_path(assigns(:criterion))
  end
